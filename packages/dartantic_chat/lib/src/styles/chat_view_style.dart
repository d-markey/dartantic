...
class ChatViewStyle {
  ...
  ///
  /// This method returns a new [ChatViewStyle] instance where each property
  ...
  ///   by the [style].
  factory ChatViewStyle.resolve(
    ChatViewStyle? style, {
    ChatViewStyle? defaultStyle,
  }) {
    defaultStyle ??= ChatViewStyle.defaultStyle();
  ...
  factory ChatViewStyle.defaultStyle() => ChatViewStyle._lightStyle();

  /// Provides a default light style.
  factory ChatViewStyle._lightStyle() => ChatViewStyle(
    ...
    llmMessageStyle: MessageStyle.defaultStyle(),
